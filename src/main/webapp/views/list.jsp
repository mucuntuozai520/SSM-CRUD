...
<body>
		...
		<div class="row">
			...
			<nav aria-label="Page navigation">
			  <ul class="pagination">
			  <li><a href="${Localhost}/emps?pn=1">首页</a></li>
			    <c:if test="${PageInfo.hasPreviousPage }">
			    <li>
			      <a href="${Localhost}/emps?pn=${PageInfo.pageNum-1}" aria-label="Previous">
			    ...
			    <c:if test="${pageNum==PageInfo.pageNum}">
			    	...
			    	<c:if test="${pageNum!=PageInfo.pageNum}">
			    	<li><a href="${Localhost}/emps?pn=${pageNum}">${pageNum}</a></li>
			    </c:if>
			    </c:forEach>
			    <c:if test="${PageInfo.hasNextPage }">
			    <li>
			      <a href="${Localhost}/emps?pn=${PageInfo.pageNum+1}" aria-label="Next">
			        <span aria-hidden="true">&raquo;</span>
			      </a>
			    </li>
			    </c:if>
			    <li><a href="${Localhost}/emps?pn=${PageInfo.pages}">末页</a></li>
			  </ul>
			</nav>
